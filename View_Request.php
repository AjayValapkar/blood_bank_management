...
<form class="d-flex" action="Search_by_Blood_group.php">
  ...
  $result = mysqli_query($link,"SELECT * FROM request_blood");
  ...
  <tr id="first">
      ...
      <td id="newone"><a href="delete_request.php? Adhar= <?php echo $row['Adhar']; ?>" aria-hidden="true" data-bs-target="tooltip" data-placement="bottom">delete</a>
  </td>
  <td id="newone"><a href="move_request.php? Adhar= <?php echo $row['Adhar']; ?>" aria-hidden="true" data-bs-target="tooltip" data-placement="bottom">Accept</a>
  </td>
