...
<!-- <form class="d-flex" action="successful_search.php">
  ...
  if(isset($_POST['search'])){
    ...
    $query="SELECT * FROM success WHERE B_group='$B_group' OR D_address='$D_address' ";
    $query_run=mysqli_query($conn,$query);
    ?>
      <h3 class="dhead">Successfull Donation </h3>
 ...
 ?>   
  ...
  $result = mysqli_query($link,"SELECT * FROM success");
